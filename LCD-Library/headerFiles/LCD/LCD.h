...
** <this function intialize the control bits for LCD Register select , 
	...
	intialize the LCD like mode of operation and home screen on >
** -------------------------------------------------------------------------*/
...
** <this function is used to send commands ( addresss ) that is provided
    by the the LCD datasheet in order to do specific operation 
    Ex sends 0x28 intialize the LCD to operate in 8 wires mode >
** -------------------------------------------------------------------------*/
...
** <this function is a special function of Lcd_display_char because it holds
    a pointer of a string and begin to incremnt that pointer by one to displayed
    more than one charachter ( sentence ) until it finds null '\0' because 
    null is the end of every charachter array or (string)	>
** -------------------------------------------------------------------------*/
