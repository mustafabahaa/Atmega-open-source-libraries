...
**
**  keypad.c
**  This is the function implemntations of a generic keypad libraries 
**  for atmega16/32 , plese review keypad.h to understands how this function
**  works and what it returns and how to use it ,  read the instructions 
*   at keypadconfig.h to best understand this library.
**
